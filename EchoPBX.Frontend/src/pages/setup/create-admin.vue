...
<template>
    <SetupLayout title="Creating an Admin user">
        <p>
            Please create the initial admin user. You will use this account to log in to the administration panel, not for making calls.
        </p>
        ...
        <div v-if="password">
            <ul class="list-inside">
                ...
                <li :class="password === confirmPassword ? 'text-green-600' : 'text-red-600'">
                    <Icon :icon="password === confirmPassword ? 'mdi:check' : 'mdi:close'" class="inline size-4 mr-1" />
                    Passwords match
                </li>
            </ul>
        </div>
